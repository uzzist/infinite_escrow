...
class DispatchEscrowDetailScreen extends StatelessWidget {
  const DispatchEscrowDetailScreen({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          border:
                              Border.all(color: Color(0xff404D58), width: 2),
                        ),
                        child: TextButton(
                            onPressed: () {
                              navigateToPage(NewMilestoneCompletedScreen());
                            },
                            child: Text(
                              "Dispatch Payment",
                              style: TextStyle(
