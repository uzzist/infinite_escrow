...
class NewTicketWithdrawlogScreen extends StatelessWidget {
  const NewTicketWithdrawlogScreen({super.key});
      ...
      child: Scaffold(
        persistentFooterButtons: [
          Container(
            ...
            child: TextButton(
                onPressed: () {
                  navigateToOffAllNextPage(NewWithdrawScreen());
                },
                child: Row(
        ...
        appBar: customAppBar(title: "New Withdraw"),
        body: Padding(
