...
class ColorConstant {
  static Color lightGreen = const Color(0xffB2F35E);
  static Color midNight = const Color(0xff11202F);
  static Color grey = const Color(0xffCFD2D6);
  static Color darkGrey = const Color(0xff404D58);
  static Color black = const Color(0xff101010);
  static Color white = const Color(0xffFFFFFF);
  static Color darkestGrey = const Color(0xff58636E);
